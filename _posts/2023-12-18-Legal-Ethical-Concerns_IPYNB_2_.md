...
- Copyright gives power to the creator of the work and allows the individual to choose whether or not others get to use their work
...
- Open source software encourages collaboration between developers by allowing for people to build on each other's work and improve the overall quality.
- Some open source software/websites like Github provides benefits/privileges to those collaborating with others
